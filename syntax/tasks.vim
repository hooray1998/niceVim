...
"exec 'syn match tStar "\v" contained '

syn region tTask start=/^\s*/ end=/$/ oneline keepend contains=tMarker,tAttribute
syn region tStar start=/^\s*☐_.*$/ end=/$/ oneline keepend contains=tMarker,tAttribute
exec 'syn region tTaskDone start="^[\s]*.*'.g:TasksAttributeMarker.'D" end=/$/ oneline contains=tMarkerComplete,tAttributeCompleted,tStar'
exec 'syn region tTaskCancelled start="^[\s]*.*'.g:TasksAttributeMarker.'C" end=/$/ oneline contains=tMarkerCancelled,tAttributeCompleted,tStar'
...
hi def link tStar Magenta_
"hi def link tStar Keyword
